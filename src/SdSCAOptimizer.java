public class SdSCAOptimizer {
    ...
    // The Main Optimizer which will return [velocity, theta]
    public static double[] optimizeMovement(Robot robot, Obstacle[] obstacles) {
        ...
        // Best population from the Global Set
        ...
        for (int t = 0; t < ITERATIONS; t++) {
            ...
            for (int i = 0; i < POPULATION; i++) {
                ...
                for (int d = 0; d < 2; d++) {
                    ...
                    // Strategy 2 Diffrential Evolution update
                    else if (strategy == 1) {

                        newSolution[d] = population[r1][d]
                                + F * (population[r2][d] - population[r3][d]);
                    }
                    // Strategy 3 Best Guided Diffrential
                    else if (strategy == 2) {
                    ...
                    // Strategy 4 Randomized Hybrid Exploration
                    else {
